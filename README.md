...
Каждый раз калькулятор открывается с одинаковыми значениями: **KGS → RUB**, объём **1 000 000**,
котировка «1 RUB = x KGS», курс поставщика — **продажа RUB Бакай Банком** (из загруженных курсов),
